 ...
 * hcy 2020/2/19
 */
public class NeedNewConnectionHandler extends SimpleChannelInboundHandler<NeedNewConnectionCmd> {

    private Logger log = LoggerFactory.getLogger(NeedNewConnectionHandler.class);

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, NeedNewConnectionCmd msg) {
        log.info("服务器需要新连接");
